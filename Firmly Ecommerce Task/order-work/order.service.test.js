...
describe('Order Service', () => {
  ...
  const validOrder = {
    ...
    shipping_address: { full_name: 'A', phone: '123456', address_line1: 'L1', city: 'C', state: 'S', postal_code: '1', country: 'IN' },
    billing_address: { full_name: 'A', phone: '123456', address_line1: 'L1', city: 'C', state: 'S', postal_code: '1', country: 'IN' },
  ...
  describe('createOrderTransaction', () => {
    ...
    it('should fetch items, validate, and execute batch', async () => {
      ...
      const itemsStub = { 
        bind: () => ({ 
          all: () => ({ results: [{ product_id: 1, snapshot_name: 'P1', snapshot_price: 10, quantity: 1 }] }) 
        }) 
      };
