...
type LayoutRouteId = RouteId | "/" | "/cart" | "/checkout" | "/login" | "/order" | "/order/[checkout_id]" | "/order/success" | "/products" | "/products/[id]" | "/register" | null
type LayoutParams = RouteParams & { checkout_id?: string; id?: string }
